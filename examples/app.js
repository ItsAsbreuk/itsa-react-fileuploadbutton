	...
	var Component = _react2.default.createClass({
	    ...
	    */
	    ...
	    componentDidMount: function componentDidMount() {
	        ...
	        instance._buttonNode = _reactDom2.default.findDOMNode(instance.refs.uploadbutton);
	    ...
	    */
	     ...
	     * @since 0.0.1
	    */
	    getTotalFileSize: function getTotalFileSize() {
	        var instance = this,
	    ...
	    */
	    send: function send() {
	        ...
	        if (!XHR2support || props.iframeMode) {
	            ...
	            if (len === 1) {
	                file = files[0];
	                promise = _itsaFetch.io.sendBlob(url, file, params, options);
	            } else if (len > 1) {
	                ...
	                for (i = 0; i < len; i++) {
	                    file = files[i];
	                    ioPromise = _itsaFetch.io.sendBlob(url, file, params, options);
	        ...
	        instance._io.then(instance._handleSuccess, instance._handleError).itsa_finally(function () {
	            return delete instance._formsubmit;
	        });
	     ...
	     * @since 0.0.1
	    */
	    _getLargestFileSize: function _getLargestFileSize() {
	        var instance = this,
	            files = instance._inputNode.files,
	            len = files.length,
	            largest = 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var NAME = "itsa-fetch",
	    ...
	    if (reviveDate && (typeof value === "undefined" ? "undefined" : _typeof(value)) === STRING) {
	    ...
	    if ((typeof parseProtoCheck === "undefined" ? "undefined" : _typeof(parseProtoCheck)) === FUNCTION && !parseProtoCheck(value)) {
	        return value;
	    }
	    if (PROTO_SUPPORTED) {
	...
	var extendIO = function extendIO(IO) {
	     ...
	     * @private
	    */
	    var _entendXHR = function _entendXHR(xhr, props, options /*, promise */) {
	        var isarray, isobject, parialdata, regexpcomma, followingstream;
	        if (_typeof(options.streamback) === FUNCTION && options.headers && options.headers.Accept === MIME_JSON) {
...
/***/ function(module, exports) {
	...
	*/
	...
	var UNKNOW_ERROR = "Unknown XDR-error",
	...
	var extendIO = function extendIO(IO) {
	    ...
	    */
	    IO.sendBlob = function (url, blob, params, options) {
	        ...
	        if ((typeof url === "undefined" ? "undefined" : _typeof(url)) !== STRING || url.length === 0) {
	        ...
	        notifyResolved = function notifyResolved(promise, loaded) {
	            promise.then(function () {
	...
	var extendIO = function extendIO(IO) {
	    ...
	    IO.insertScript = function (url) {
	        ...
	        promise = new Promise(function (fulfill, reject) {
	            ...
	            fulfillSubscriber = function fulfillSubscriber() {
	                unsubScribe();
	                fulfill(newNode);
	            };
	            rejectSubscriber = function rejectSubscriber(e) {
	                unsubScribe();
	...
	*/
	...
	var extendIO = function extendIO(IO) {
	    ...
	    var isCrossDomain = function isCrossDomain(url) {
	        ...
	        entendXHR = function entendXHR(xhr, props, options /*, promise */) {
	        var crossDomain;
	        if (!props._isXHR2) {
	        ...
	        readyHandleXDR = function readyHandleXDR(xhr, promise, headers /*, method */) {
	        if (xhr._isXDR) {
	            // for XDomainRequest, we need "onload" instead of "onreadystatechange"
...
/***/ function(module, exports) {
	...
	*/
	...
	var extendIO = function extendIO(IO, DOMParser) {
